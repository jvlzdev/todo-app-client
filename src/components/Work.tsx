        ...
        <div className="flex-1 mr-5">
          <ol className="relative border-l border-gray-300 dark:border-gray-700">
            <li className="mb-2 ml-4">
              ...
              <time className="mb-1 text-xs xs:text-[0.5rem] font-normal leading-none text-gray-400 dark:text-gray-500">
                October 2022 - Present
              </time>
              <h3 className="text-base xs:text-sm font-semibold text-gray-900 dark:text-white">
                Atos Information Technology, Inc.
              </h3>
              <p className="mb-2 text-sm xs:text-xs font-normal text-gray-500 dark:text-gray-400">
